...
<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" {width} {height} viewBox="0 0 64 64">
	<radialGradient
		id="uCZz3JcUOJjrtrvOyVUpaa_SyIpM4vSpYTF_gr1"
		cx="33.34"
		cy="36.064"
		r="43.888"
		gradientTransform="translate(0 2)"
		gradientUnits="userSpaceOnUse"
		><stop offset="0" stop-color="#f4e9c3"></stop><stop offset=".219" stop-color="#f8eecd"
		></stop><stop offset=".644" stop-color="#fdf4dc"></stop><stop offset="1" stop-color="#fff6e1"
		></stop></radialGradient
	><path
		fill="url(#uCZz3JcUOJjrtrvOyVUpaa_SyIpM4vSpYTF_gr1)"
	...
	></path><linearGradient
		id="uCZz3JcUOJjrtrvOyVUpab_SyIpM4vSpYTF_gr2"
		x1="32"
		x2="32"
		y1="5.723"
		y2="55.93"
		gradientUnits="userSpaceOnUse"
		><stop offset="0" stop-color="#a4a4a4"></stop><stop offset=".619" stop-color="gray"></stop><stop
			offset="1"
			stop-color="#6f6f6f"
		></stop></linearGradient
	><path
